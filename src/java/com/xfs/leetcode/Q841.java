...
/**
 * @author fansong Created on 2020/8/31 0031
 */
public class Q841 {
	/**
	 ...
	 * 然后我们去 2 号房间，拿到钥匙 3。 最后我们去了 3 号房间。 由于我们能够进入每个房间，我们返回 true。 示例 2：
	 *
...
class TestQ841 {
	public static void main(String[] args) {
		...
		List<List<Integer>> rooms = (List<List<Integer>>) JSON
				.parse("[[1,2],[2],[]]");
