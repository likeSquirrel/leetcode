...
/**
 * @author fansong Created on 2021/3/5 0005
 */
public class Q232 {
	/**
	 ...
	 * empty 操作是合法的。 你所使用的语言也许不支持栈。你可以使用 list 或者 deque（双端队列）来模拟一个栈，只要是标准的栈操作即可。
	 *  
	 *
	 * 进阶：
	 *
	 ...
	 * 提示：
	 *
	 * 1 <= x <= 9 最多调用 100 次 push、pop、peek 和 empty 假设所有操作都是有效的 （例如，一个空的队列不会调用
	 * pop 或者 peek 操作）
	 *
	 * 来源：力扣（LeetCode）
